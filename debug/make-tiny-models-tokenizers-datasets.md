...
```
See [idefics-make-tiny-model.py](https://github.com/stas00/ml-engineering/blob/master/debug/tiny-scripts/idefics-make-tiny-model.py) for a fully working script (I didn't bother adding the vocab shrinking as I'm just demonstrating how to update nested config objects here).
