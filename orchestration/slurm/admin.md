...
Here is the script that does all that work for you: [undrain-good-nodes.sh](https://github.com/stas00/ml-engineering/blob/master/orchestration/slurm/undrain-good-nodes.sh)
